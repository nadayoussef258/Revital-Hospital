...
@Component({
        ...
        <div class="row g-4">
          <div class="col-lg-4 col-md-6" *ngFor="let dept of departments">
            <div class="department-card h-100">
              ...
              <div class="department-image-wrapper" *ngIf="dept.image">
                <img [src]="dept.image" 
                     [alt]="dept.title" 
              ...
              <div class="department-icon" *ngIf="!dept.image">
  ...
  styles: [`
    ...
    /* Unified styling for both icon and image */
    .department-icon,
    .department-image-wrapper {
      ...
      box-shadow: 0 8px 25px rgba(46, 125, 181, 0.2);
      position: relative;
      overflow: hidden;
    }
    ...
    .image-overlay {
      position: absolute;
      inset: 0;
      background: linear-gradient(135deg, rgba(46, 125, 181, 0.7), rgba(104, 168, 216, 0.5));
      opacity: 0;
    ...
    .department-card:hover .department-image-wrapper {
      transform: scale(1.15) rotate(5deg);
      box-shadow: 0 12px 35px rgba(46, 125, 181, 0.3);
    }
    ...
    .department-card:hover .image-overlay {
      opacity: 0.3;
    }
