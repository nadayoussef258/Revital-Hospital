  ...
  departments: Department[] = [
    {
      ...
      description: 'صحة قلبك هي أولويتنا القصوى. ثق بقسم أمراض القلب لدينا للحصول على رعاية متخصصة وعلاجات متقدمة.',
      features: [
        'أطباء قلب معتمدون دولياً',
        'طب القلب الوقائي',
        'تصوير القلب المتقدم'
      ]
    },
    {
      icon: 'activity',
      title: 'قسم طب الأعصاب',
      description: 'في قسم طب الأعصاب، نقدم رعاية عصبية شاملة وخطط علاجية شخصية وعلاجات داعمة متطورة.',
      features: [
    ...
    {
      icon: 'prescription',
      title: 'قسم طب الأسنان',
      description: 'نقدم رعاية أسنان شاملة وحديثة وخدمات تجميلية لضمان صحة فمك وابتسامتك في أيدٍ خبيرة.',
      features: [
        'زراعة الأسنان',
        'جراحة الأسنان',
        'تجميل الأسنان'
    ...
    },
    {
      ...
      description: 'رعاية متخصصة للرضع والأطفال والمراهقين مع خبراء طب الأطفال الرحماء لضمان نمو صحي وسليم.',
      features: [
        'متابعة نمو الطفل',
        'جراحة الأطفال',
        'برامج التطعيم'
    ...
    },
    {
      icon: 'eye',
      title: 'قسم طب العيون',
      description: 'خدمات رعاية عيون شاملة من الفحوصات الروتينية إلى الإجراءات الجراحية المتقدمة لجميع احتياجات الرؤية.',
      features: [
        'فحص النظر الشامل',
        'جراحة العيون',
        'العلاج بالليزر'
    ...
    },
    {
      ...
      description: 'صيدلية متكاملة الخدمات توفر الأدوية والاستشارات والمشورة الصحية لتحقيق أفضل رعاية للمرضى.',
      features: [
